...
const ActionModal: FunctionComponent<PropsWithChildren<Props>> = ({ children, contentStyle, style, visible }) => {
  const colorScheme = useAppColorScheme();
  return (
    <Modal animationType="fade" statusBarTranslucent style={style} transparent visible={visible}>
      <View style={[styles.background, { backgroundColor: colorScheme.overlay }]}>
